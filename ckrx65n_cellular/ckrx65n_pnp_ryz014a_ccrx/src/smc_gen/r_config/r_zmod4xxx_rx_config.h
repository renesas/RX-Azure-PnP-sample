...
#define RM_ZMOD4XXX_CFG_DEVICE_NUM_MAX                    (2) /* Number (max.) of ZMOD4xxx Sensors */
...
#define RM_ZMOD4XXX_CFG_DEVICE0_IRQ_NUMBER                (IRQ_NUM_14)

/* SPECIFY IRQ TRIGGER FOR DEVICE0 */
#define RM_ZMOD4XXX_CFG_DEVICE0_IRQ_TRIGGER               (IRQ_TRIG_FALLING)

/* SPECIFY IRQ PRIORITY FOR DEVICE0 */
#define RM_ZMOD4XXX_CFG_DEVICE0_IRQ_PRIORITY              (IRQ_PRI_2)

/* SPECIFY OPERATION MODE FOR DEVICE1 */
#define RM_ZMOD4XXX_CFG_DEVICE1_OPERATION_MODE            (6) /* Set operation mode of ZMOD4XXX Sensor device1 */

/* SPECIFY USING COMMUNICATION LINE INSTANCE FOP DEVICE1 */
#define RM_ZMOD4XXX_CFG_DEVICE1_COMMS_INSTANCE            (g_comms_i2c_device2)
...
#define RM_ZMOD4XXX_CFG_DEVICE1_IRQ_ENABLE                (1)
...
#define RM_ZMOD4XXX_CFG_DEVICE1_IRQ_NUMBER                (IRQ_NUM_13)

/* SPECIFY IRQ TRIGGER FOR DEVICE1 */
#define RM_ZMOD4XXX_CFG_DEVICE1_IRQ_TRIGGER               (IRQ_TRIG_FALLING)

/* SPECIFY IRQ PRIORITY FOR DEVICE1 */
#define RM_ZMOD4XXX_CFG_DEVICE1_IRQ_PRIORITY              (IRQ_PRI_3)
