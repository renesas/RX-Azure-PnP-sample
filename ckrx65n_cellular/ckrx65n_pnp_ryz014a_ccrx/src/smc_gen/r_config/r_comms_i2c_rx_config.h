...
#define COMMS_I2C_CFG_DEVICE2_SLAVE_ADDR       (0x33) /* Slave address */
#define COMMS_I2C_CFG_DEVICE2_ADDR_MODE        (1) /* Address mode */
#define COMMS_I2C_CFG_DEVICE2_CALLBACK         (rm_zmod4xxx_callback1) /* Callback function */
...
#define COMMS_I2C_CFG_DEVICE3_SLAVE_ADDR       (0x53) /* Slave address */
#define COMMS_I2C_CFG_DEVICE3_ADDR_MODE        (1) /* Address mode */
#define COMMS_I2C_CFG_DEVICE3_CALLBACK         (rm_ob1203_callback0) /* Callback function */
...
#define COMMS_I2C_CFG_DEVICE4_SLAVE_ADDR       (0x53) /* Slave address */
#define COMMS_I2C_CFG_DEVICE4_ADDR_MODE        (1) /* Address mode */
#define COMMS_I2C_CFG_DEVICE4_CALLBACK         (rm_ob1203_callback1) /* Callback function */
...
#define COMMS_I2C_CFG_DEVICE5_SLAVE_ADDR       (0x63) /* Slave address */
#define COMMS_I2C_CFG_DEVICE5_ADDR_MODE        (1) /* Address mode */
#define COMMS_I2C_CFG_DEVICE5_CALLBACK         (comms_i2c_callback_icp) /* Callback function */
...
#define COMMS_I2C_CFG_DEVICE6_SLAVE_ADDR       (0x68) /* Slave address */
#define COMMS_I2C_CFG_DEVICE6_ADDR_MODE        (1) /* Address mode */
#define COMMS_I2C_CFG_DEVICE6_CALLBACK         (comms_i2c_callback_icm) /* Callback function */
