 ...
 * Stacks definitions
 **********************************************************************************************************************/
UCHAR               sensor_thread_memory_stack[2048];
UCHAR               ob1203_thread_memory_stack[2048];
...
void tx_application_define_user (void)
{
    ...
    status_sensor_thread = tx_thread_create(&sensor_thread, "sensor_thread", sensor_thread_entry, 0, sensor_thread_memory_stack, 2048, 2, 1, 2, TX_AUTO_START);
    ...
    status_ob1203_thread = tx_thread_create(&ob1203_thread, "ob1203_thread", ob1203_thread_entry, 0, ob1203_thread_memory_stack, 2048, 1, 1, 2, TX_AUTO_START);
