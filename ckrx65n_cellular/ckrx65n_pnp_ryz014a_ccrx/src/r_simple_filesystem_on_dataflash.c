...
static const SFD_CONTROL_BLOCK sfd_control_block_data __attribute__((section("system_config"))) = {SFD_CONTROL_BLOCK_INITIAL_DATA};
static const SFD_CONTROL_BLOCK sfd_control_block_data_mirror __attribute__((section("system_config"))) = {SFD_CONTROL_BLOCK_INITIAL_DATA};
#elif defined(__ICCRX__)
#pragma default_variable_attributes = @ ".dataflash"
static const SFD_CONTROL_BLOCK sfd_control_block_data = {SFD_CONTROL_BLOCK_INITIAL_DATA};
static const SFD_CONTROL_BLOCK sfd_control_block_data_mirror = {SFD_CONTROL_BLOCK_INITIAL_DATA};
...
sfd_err_t R_SFD_Scan(uint8_t **label, uint32_t *label_length, uint8_t **data, uint32_t *data_length)
{
	...
	else
	{
		while(1)
		{
			...
			{
				*label = (uint8_t *)&sfd_control_block_data_image.data.sfd_data[current_handle_index].label;
