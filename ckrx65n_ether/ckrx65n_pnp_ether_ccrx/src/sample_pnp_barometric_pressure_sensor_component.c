...
UINT sample_barometric_sensor_telemetry_messages_send(NX_AZURE_IOT_HUB_CLIENT *pnp_client_ptr);
...
UINT sample_barometric_sensor_telemetry_messages_send(NX_AZURE_IOT_HUB_CLIENT *pnp_client_ptr)
{
	...
	st_sensorsICP_t icp10101_Data;
     ...
     /* Get  ICP temperature, pressure and gas_resistance */
