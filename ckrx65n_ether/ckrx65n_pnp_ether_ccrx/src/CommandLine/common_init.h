...
#define SHORT_NAME      "RX65N"
#define FULL_NAME       ("CK-RX65N")
#define PART_NUMBER     ("RTK5CK65N0C00000BE")
#define DEVICE_NUMBER   ("R5F565NEHxFB")
...
#define BLINK_FREQ_1HZ        (46874)      /* 1HZ */
#define BLINK_FREQ_5HZ        (18749)      /* 5HZ */
#define BLINK_FREQ_10HZ       (9374)       /* 10HZ */
...
#define STATUS_ENABLE_ETHERNET       (1 << 6)   /* Enable Ether Thread to connect (on required once) */
#define STATUS_ETHERNET_LINKUP       (1 << 7)   /* Ethernet is UP / Down */
#define STATUS_OB2103_UP             (1 << 8)   /* ob1203sd-c4r READY TO INITIALIE */
#define STATUS_OB2103_READ           (1 << 9)   /* ob1203sd-c4r READY TO INITIALIE */
#define STATUS_OB2103_READ_COMPLETED (1 << 10)   /* ob1203sd-c4r READY TO INITIALIE */
...
// TODO extern bsp_leds_t g_bsp_leds;
